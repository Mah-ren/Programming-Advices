...
int main()
{
    ...
    cout << "\nthis is the first extension GetItem(2) means the second index: " << MyQueue.GetItem(2);
    cout << "\nExtension2: Reverse()";
    MyQueue.Reverse();
    MyQueue.Print();
    ...
    MyQueue.InsertAtBack(88);
    cout << "\nthis is the Extension5 insert 88 at back: ";
    MyQueue.Print();

    cout << "\nthis is the size before clear(): " << MyQueue.Size();
    ...
    cout << "\nthis is the size after clear(): " << MyQueue.Size();
