...
void PrintClientsData(CD Clients[10][5], vector<string> &vFileContent);
void PrintOneClientData(CD Clients[10][5], short clientNumber);
void LoadDataFromVectorOfLinesOfStringsToVectorOfStruct(CD Clients[10][5], vector<string> &, string);
...
void ShowClientsStatement(size_t , CD Clients[10][5]);
...
void LoadDataFromVectorOfLinesOfStringsToVectorOfStruct(CD Clients[10][5], vector<string> &vFileContent, string delimiter)
{
    vector<string> vLine;
...
void ShowClientsStatement(size_t numberOfClients, CD Clients[10][5])
{
    cout << "\n"
         << Tabs(5) << "Client List [" << numberOfClients << "] Client(s)\n"
         << "----------------------------------------------------------------------------------------------------" << endl
