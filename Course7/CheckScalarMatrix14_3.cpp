//todo this is the scalar matrix that the diagonal with the same numbers and the rest are zeros 
...
void PrintIfMatrixIsScalar(int matrix1[100][100] , int rows , int columns)
{
    isScalarMatrix(matrix1 , rows , columns) ? cout << "\nThis is a Scalar Matrix\n" : cout << "\nThis is Not a Scalar Matrix\n";
}
...
void Project()
{
    ...
    PrintIfMatrixIsScalar(matrix , rows , columns);
