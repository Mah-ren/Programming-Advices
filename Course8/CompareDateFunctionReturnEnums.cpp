...
enum enCompareTwoFunctions
{
    enDate1BeforeDate2 = 1,
    enDate1EqualToDate2 = 0,
    enDate1AfterDate2 = -1
};
struct stDate
{
...
short GetDifferenceInDays(stDate Date1, stDate Date2, bool IncludeEndDay)
{
    if (IsDate1EqualToDate2(Date1, Date2))
        return enCompareTwoFunctions::enDate1EqualToDate2;
    else if (!IsDate1BeforeDate2(Date1, Date2))
        return enCompareTwoFunctions::enDate1AfterDate2;
    return enCompareTwoFunctions::enDate1BeforeDate2;
