...
short isAmountExceedsTheBalance(short, short);
...
short isAmountExceedsTheBalance(short balance, short withrrawAmount)
{
    while(withrrawAmount > balance)
    {
        cout << "\nAmount Exceeds the balance, you can withdraw up to: " << balance
            << "\nPlease Enter another amount: ";
        cin >> withrrawAmount;
    }
    return withrrawAmount;
}
bool isVectorEmpty(vector<CD>& vClients)
{
...
static void PerformFindClient(vector<CD>& vClients)
{
    system("cls");
